...
exports.addReview = async (req, res) => {
  ...
  if(!req.user.isVerified) return sendError(res, "Please verify your email first!", 403);
...
exports.getReviewByMovie = async (req, res) => {
   ...
   const movie = await Movie.findById(movieId).populate({path:"reviews", populate:{path:"owner", select:"name"}}).select("reviews title");
